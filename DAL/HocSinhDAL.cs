...
namespace DAL
{
...

    {
        ...
        {
            if (db.HocSinhs.Where(t => t.Mssv.Equals(username)).FirstOrDefault() != null)
            {
                return true;
            }
            return false;
        ...
        public HocSinh checkPassword(string username, string pass)
        {
        ...
        public bool AddHocSinh(HocSinh hs)
        {
            try
            {
